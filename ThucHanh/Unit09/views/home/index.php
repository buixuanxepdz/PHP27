...
<body class="sticky-nav-on">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo-container">
                            <a href="index.php">
                                <img style="width: 70px;height: 40px;" src="public/images/zenter.png" alt="Maverick Logo">
                            </a>
                        </div><!-- /logo-container -->
                    </div><!-- /col-md-12 -->
                </div><!-- /row -->
        ...
        <aside id="sideheader">
            <header>
                <div class="logo-container">
                    <a href="index.php"><img src="public/images/zenter.png" alt="Maverick"></a>
                </div><!-- /logo-container -->
                             ...
                             ?>
                                <article class="blog-post">
                                    <header>
                                        ...
                                        <h4><a href="index.php?admin=admin&mod=post&act=detailuser&id=<?= $value['id']?>"><?= $value['description']; ?></a></h4>
                                    </header>
                                    <footer>
                                        <div class="meta">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="widget widget_text">
                    <h5>About Us</h5>
                    <div class="textwidget">
                        <img width="100px" height="50px" src="public/images/zenter.png" alt="Maverick">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
