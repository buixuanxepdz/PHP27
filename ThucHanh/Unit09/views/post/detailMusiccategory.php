    ...
    <body class="archive sticky-nav-on">
        ...
        <aside id="sideheader">
            <header>
                ...
                <a href="index.html" class="sideheader-close-btn">
                    <span></span>
                    <span></span>
                </a>
            </header>
            ...
            <p class="copyright">Copyright © BXX</p>
        </aside><!-- /sideheader -->
                            ...
                            <div class="contents-inner list-view clearfix">
                                ...
                                <article class="blog-post col-md-12">
                                    ...
                                    <div class="contents">
                                        <header>
                                            <ul class="categories">
                                                <li><a href="index.php?admin=admin&mod=post&act=detailuser&id=<?= $value['id']?>"><?= $value['category_name'] ?></a></li>
                                            </ul>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="widget widget_text">
                                <h5>About Us</h5>
                                <div class="textwidget">
                                    <img width="120px" height="50px" src="public/images/zenter.png" alt="Maverick">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
